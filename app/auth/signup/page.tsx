    ...
    <div className="min-h-screen bg-gray-50 flex flex-col justify-center py-12 sm:px-6 lg:px-8">
      <div className="sm:mx-auto sm:w-full sm:max-w-md">
        ...
        >
          ...
          <h2 className="text-4xl md:text-5xl font-medium tracking-tighter leading-none text-black">Get started</h2>
          <p className="mt-2 text-sm font-light text-gray-600">Create your business travel account</p>
        </motion.div>
      </div>
