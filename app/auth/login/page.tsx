    ...
    <div className="min-h-screen bg-gray-50 flex flex-col justify-center py-12 sm:px-6 lg:px-8">
      <div className="sm:mx-auto sm:w-full sm:max-w-md">
        ...
        >
          <div className="flex items-center justify-center gap-2 mb-6">
            <div className="inline-flex items-center rounded-xl bg-gray-200 px-3 py-1.5 text-xs font-medium text-gray-700">
              <Image
          ...
          <h2 className="text-4xl md:text-5xl font-medium tracking-tighter leading-none text-black">Sign in</h2>
          <p className="mt-2 text-sm font-light text-gray-600">Access your business travel dashboard</p>
        </motion.div>
      </div>
      ...
      <div className="mt-8 sm:mx-auto sm:w-full sm:max-w-md">
        <motion.div
          ...
          className="bg-white/50 backdrop-blur-sm py-8 px-4 shadow-sm sm:rounded-2xl sm:px-10 border border-gray-200"
        >
          <form className="space-y-6" onSubmit={handleLogin}>
            ...
            <div>
              ...
              <div className="relative">
                <input
                  ...
                  className="w-full px-4 py-3 bg-white border border-gray-200 rounded-xl text-gray-900 placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-black focus:border-transparent font-light pr-12"
                />
                <button
                  type="button"
            ...
            <div className="text-center">
              <span className="text-sm text-gray-600 font-light">
                ...
                <Link href="/auth/signup" className="font-medium text-black hover:text-gray-800 transition-colors">
                  Sign up
                </Link>
              </span>
            </div>
