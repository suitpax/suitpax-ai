    ...
    <div className="min-h-screen bg-gray-50 flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
      <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="max-w-md w-full space-y-8">
        <div className="text-center">
          ...
          <h2 className="text-4xl font-medium tracking-tighter text-black">Welcome back</h2>
          <p className="mt-2 text-sm font-light text-gray-600">Sign in to your AI-powered travel dashboard</p>
        </div>
