	...
	const submitContact = async (e: React.FormEvent) => {
		...
		try {
			...
			const resp = await fetch('/api/contact', {
				...
				headers: { 'Content-Type': 'application/json' },
				body: JSON.stringify({
					// The API route expects name and subject; provide sensible defaults
					email: contactEmail,
		...
		>
			<div className="container mx-auto px-4 md:px-6 relative z-10 py-16 md:py-24">
				<div className="flex flex-col items-center text-center">
					...
					{/* Official launch countdown badge moved under subtitle with black text */}
					<div className="mt-2">
						<MiniCountdownBadge target={new Date('2025-10-21T00:00:00Z')} title="Official launch" variant="light" />
					</div>

					{/* Lime pulse loading badge replacing predictive/booting badges */}
					<div className="mt-3">
					...
					{/* Clean mini badges row with tooltip removed (per rework) */}
					...
					{/* Airlines slider moved lower below the form */}
					...
					{/* Key highlights - remove predictive white card and black booting badge; keep simple content */}
					...
					<div className="flex items-center gap-3 mt-5">
						{/* Removed duplicate countdown and private beta small badge */}
					</div>
				</div>
			</div>
