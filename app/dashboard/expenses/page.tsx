...
export default function ExpensesPage() {
  ...
  const EmptyState = () => (
    <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="text-center py-16">
      ...
      <h3 className="text-2xl font-medium tracking-tighter text-gray-900 mb-3">No expenses found</h3>
      ...
      {!searchQuery && selectedCategory === "all" && selectedStatus === "all" && (
        <Button
          ...
          className="bg-gray-900 text-white hover:bg-gray-800 px-8 py-3 rounded-xl font-medium tracking-tight"
          disabled={loading}
        >
    ...
    <div className="space-y-8 p-4 lg:p-0">
      ...
      >
        ...
        <select
          ...
          className="px-4 py-2 bg-white border border-gray-200 rounded-xl text-gray-900 focus:outline-none focus:ring-2 focus:ring-gray-900 focus:border-transparent font-medium"
        >
            ...
            <CardContent className="p-8">
              <div className="flex items-center justify-between mb-8">
                ...
                <Button
                  ...
                  className="text-gray-600 hover:text-gray-800 rounded-xl border-gray-200 bg-transparent"
                >
                  Cancel
                </Button>
              </div>
