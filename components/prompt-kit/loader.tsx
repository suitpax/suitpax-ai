...
// Fullscreen overlay loader for flight search
export function FullscreenOverlay({ label = "Searching the best fares…" }: { label?: string }) {
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-white/85 backdrop-blur">
