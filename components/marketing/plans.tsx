...
const pricingPlans = [
  {
    ...
    badge: "Free",
    popular: false,
    agentImage: "/agents/agent-57.png",
  ...
  },
  {
    ...
    badge: "Starter",
    popular: true,
    agentImage: "/agents/agent-58.png",
  ...
  },
  {
    ...
    badge: "Most Popular",
    popular: false,
    agentImage: "/agents/agent-59.png",
    communityImages: [
      "/community/ammar-foley.webp",
      "/community/owen-harding.webp",
      "/community/nicolas-trevino.webp",
  ...
  },
  {
    ...
    badge: "Enterprise",
    popular: false,
    agentImage: "/agents/agent-60.png",
    communityImages: [
      "/community/ammar-foley.webp",
      "/community/owen-harding.webp",
      "/community/jordan-burgess.webp",
...
const MiniChat = ({ planId }: { planId: string }) => {
  ...
  const getAgentImage = () => {
    switch (planId) {
      case "free":
        return "/agents/agent-57.png"
      case "basic":
        return "/agents/agent-58.png"
      case "pro":
        return "/agents/agent-59.png"
      case "enterprise":
        return "/agents/agent-60.png"
      default:
        return "/agents/agent-1.png"
    }
  }
