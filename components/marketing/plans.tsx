...
const pricingPlans = [
  {
    id: "beta",
    name: "Beta Access",
    description: "Early access for innovative teams wanting to shape the future of business travel",
    price: "Limited",
    annualPrice: "Limited",
    period: "beta access",
    annualPeriod: "beta access",
    features: [
  ...
  },
  {
    ...
    communityImages: communityImages.early,
    bgGradient: "from-gray-50 to-gray-100",
  },
  {
    id: "startups",
    name: "Scale-up",
    description: "For medium-sized businesses looking to optimize their travel operations",
    price: "$129",
    annualPrice: "$99",
    period: "per month",
    annualPeriod: "per month, billed annually",
    ...
    popular: false,
    agentImage: "/agents/agent-13.png",
    communityImages: communityImages.startups,
    bgGradient: "from-gray-50 to-gray-100",
  },
  {
    id: "unicorn",
    ...
    communityImages: communityImages.unicorn,
    bgGradient: "from-gray-50 to-gray-100",
  },
]
  ...
  return (
    <section className="py-16 sm:py-20 md:py-24 bg-gradient-to-b from-white to-gray-50">
      <div className="container mx-auto px-4 md:px-6">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-5 gap-4 sm:gap-5 md:gap-6 max-w-7xl mx-auto">
          {pricingPlans.map((plan, index) => (
            ...
            >
              ...
              <motion.div whileHover={{ scale: 1.03 }} whileTap={{ scale: 0.98 }} className="mt-4">
                <Link
                  href={
                    plan.id === "unicorn" || plan.id === "early" || plan.id === "startups"
                      ? "mailto:hello@suitpax.com"
                      : "/signup"
                  }
                  className={`w-full py-2 px-4 rounded-xl text-center text-[10px] sm:text-xs font-medium transition-all ${
                    plan.popular
        ...
        >
          ...
          <div className="grid grid-cols-5 gap-3 sm:gap-4 max-w-4xl mx-auto">
            <div className="text-center">
              ...
              <p className="text-[10px] sm:text-xs font-medium">Beta</p>
            ...
            <div className="text-center">
              ...
              <p className="text-[10px] sm:text-xs font-medium">Early</p>
            ...
            <div className="text-center">
              ...
              <p className="text-[10px] sm:text-xs font-medium">Scale-up</p>
              <p className="text-[8px] sm:text-[10px] text-gray-500">50K tokens</p>
            </div>
            <div className="text-center">
              <div className="w-full bg-gray-200 h-1 mb-1.5 rounded-full overflow-hidden">
                <div className="bg-emerald-950 h-1 w-full rounded-full"></div>
              </div>
              <p className="text-[10px] sm:text-xs font-medium">Unicorn</p>
