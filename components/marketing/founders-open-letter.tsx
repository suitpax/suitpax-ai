        ...
        <div className="max-w-2xl mx-auto">
          ...
          >
            ...
            <div className="space-y-3 text-xs text-white/70 italic font-serif">
              ...
              <p>
                "My vision goes beyond just another travel platform—we're creating an ecosystem that truly understands
          ...
          >
            <p className="text-white/80 italic font-serif max-w-3xl mx-auto text-xs">
              "I am committed to building a platform that doesn't just meet the needs of today's business travelers but
