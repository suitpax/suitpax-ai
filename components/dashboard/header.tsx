    ...
    <>
      <header className="bg-white/70 backdrop-blur-sm border-b border-white/20 px-4 lg:px-6 py-4 sticky top-0 z-40">
        <div className="flex items-center justify-between">
          ...
          {/* Center Section - AI Prompt */}
          <div className="hidden lg:flex flex-1 max-w-lg mx-8">
            <GlobalPromptInput placeholder="Search or ask AI anything..." className="bg-white/80 border border-gray-200/50" />
          </div>
        ...
        {isMobile && (
          <div className="mt-4 sm:hidden">
            <GlobalPromptInput placeholder="Search or ask AI..." className="bg-white/80 border border-gray-200/50" />
          </div>
        )}
      </header>
