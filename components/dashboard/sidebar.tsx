...
export function Sidebar({ onUserUpdate }: SidebarProps) {
  ...
  return (
    <>
      <div className="hidden md:flex md:w-64 md:flex-col">
        <div className="flex flex-col flex-grow pt-5 bg-white border-r border-gray-200 overflow-y-auto">
          <div className="flex items-center flex-shrink-0 px-4">
            <img className="h-8 w-auto" src="/logo/suitpax-green-logo.webp" alt="Suitpax" />
          </div>
      ...
      <div className="flex flex-col h-full bg-white border-r border-gray-200 md:hidden">
        {/* Logo */}
        <div className="flex items-center h-16 px-6 border-b border-gray-200">
        ...
        <div className="flex-shrink-0 border-t border-gray-200 p-4">
          ...
          >
            ...
            <Mic className="h-4 w-4 text-gray-400 group-hover:text-gray-600 transition-colors" />
          </button>
        </div>
      </div>
          ...
          <div className="space-y-1">
            ...
            <div className="space-y-1">
              ...
              <div className="px-3 py-2">
                <div className="flex items-center space-x-2">
                  {[
                    { value: "light", icon: Plane, label: "Light" },
                    { value: "dark", icon: Building2, label: "Dark" },
                    { value: "system", icon: CreditCard, label: "System" },
                  ].map((themeOption) => (
                    <button
                    ...
                    >
                      ...
                      {theme === themeOption.value && <BarChart3 className="h-3 w-3" />}
                    </button>
                  ))}
                </div>
              </div>
