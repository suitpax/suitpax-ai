  ...
  return (
    <Popover open={open} onOpenChange={setOpen}>
      <PopoverTrigger asChild>
        <Button variant="outline" className="w-full justify-between rounded-2xl bg-white text-gray-900 border-gray-300 hover:bg-gray-50">
      ...
      <PopoverContent className="p-0 w-[360px] rounded-2xl border border-gray-200 bg-white shadow-lg">
