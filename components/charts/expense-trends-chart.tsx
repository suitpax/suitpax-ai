      ...
      <Card className="bg-white/50 backdrop-blur-sm border border-gray-200 shadow-sm rounded-2xl">
        ...
        <CardContent className="pt-0">
          ...
          <div className="h-64 w-full">
            <ResponsiveContainer width="100%" height="100%">
              <AreaChart data={expenseData} margin={{ top: 10, right: 10, left: 10, bottom: 10 }}>
                ...
                />
                <Area type="monotone" dataKey="total" stroke="#374151" strokeWidth={2} fill="url(#totalGradient)" name="Total" />
                <Area type="monotone" dataKey="flights" stroke="#6B7280" strokeWidth={1.5} fill="url(#flightsGradient)" name="Flights" />
                <Area type="monotone" dataKey="hotels" stroke="#9CA3AF" strokeWidth={1.5} fill="url(#hotelsGradient)" name="Hotels" />
              </AreaChart>
            </ResponsiveContainer>
          </div>
          ...
          <div className="text-center mt-6 p-4 bg-gray-50 rounded-xl">
            ...
            <p className="text-xs text-gray-500">Your spending trends will appear here after your first business trip</p>
          </div>
        </CardContent>
      </Card>
    </motion.div>
